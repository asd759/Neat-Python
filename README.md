...
This project uses NEAT (NeuroEvolution of Augmenting Topologies) to evolve neural networks that learn to play games automatically.
Instead of writing rules for the player, the AI improves over generations through natural selection.
